   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - ZENITH STORE | RizkiNurFitrian
              By <a href="https://www.canva.com/design/DAFnqmm9u10/jruU2Bx-Iiy_cyJagByNFA/edit?utm_content=DAFnqmm9u10&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" style="color:yellow;font-weight:700;" target="_blank">Rian.Web</a>
              <a href="#" class="go-top">
